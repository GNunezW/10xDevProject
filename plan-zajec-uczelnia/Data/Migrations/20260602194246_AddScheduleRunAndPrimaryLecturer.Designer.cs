...
namespace plan_zajec_uczelnia.Data.Migrations
{
    ...
    [Migration("20260602194246_AddScheduleRunAndPrimaryLecturer")]
    partial class AddScheduleRunAndPrimaryLecturer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Data.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Models.LecturerAvailability", b =>
                {
                    ...
                    b.HasKey("LecturerId", "DayOfWeek", "TimeSlotId");
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Models.ScheduleRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Models.ScheduledSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ScheduleRunId", "SubjectId", "GroupIndex", "SessionIndex")
                        .IsUnique();
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Models.SemesterPeriod", b =>
                {
                    ...
                    b.Property<int>("SemesterOrdinal")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AcademicYear", "SemesterOrdinal")
                        .IsUnique();

                    b.ToTable("SemesterPeriods");
                });

            modelBuilder.Entity("plan_zajec_uczelnia.Models.StudyProgram", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Models.StudyProgramEnrollment", b =>
                {
                    ...
                    b.HasKey("StudyProgramId", "Semester");

                    b.ToTable("StudyProgramEnrollments");
                });
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Models.SubjectLecturer", b =>
                {
                    b.Property<int>("SubjectId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Models.TimeSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("plan_zajec_uczelnia.Data.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Models.LecturerAvailability", b =>
                {
                    b.HasOne("plan_zajec_uczelnia.Models.Lecturer", "Lecturer")
                        .WithMany()
                        .HasForeignKey("LecturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("plan_zajec_uczelnia.Models.TimeSlot", "TimeSlot")
                        .WithMany()
            ...
            modelBuilder.Entity("plan_zajec_uczelnia.Models.ScheduledSession", b =>
                {
                    ...
                    b.HasOne("plan_zajec_uczelnia.Models.Room", "Room")
                        .WithMany()
                        .HasForeignKey("RoomNumber")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("plan_zajec_uczelnia.Models.ScheduleRun", "ScheduleRun")
                    ...
                    b.HasOne("plan_zajec_uczelnia.Models.Subject", "Subject")
                        .WithMany()
